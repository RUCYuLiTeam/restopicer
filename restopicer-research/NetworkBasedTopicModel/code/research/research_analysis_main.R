...
load("rdata/research_2011_2013_again/cutat_th=0.5_th=0.5.RData")
load("rdata/research_2011_2013/result_fastgreedy_40.RData")
######
...
calcommunity.coverage(community_term,trival_th = 13)
caloverlap.coverage(community_term,trival_th = 13)
...
calcommunity.balance(community_term,trival_th = 13)
