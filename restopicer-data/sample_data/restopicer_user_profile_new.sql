...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-12-10 01:12:21
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `mission_info` (
  ...
  `mission_round` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `mission_info` (`mission_id`, `beginning_year`, `ending_year`, `mission_round`, `name`) VALUES
(3, 1975, 2014, 1, 'Joshua'),
(2, 1975, 2014, 17, 'Joshua'),
(7, 1975, 2014, 0, 'Joshua');
...
INSERT INTO `preference_keyword` (`id`, `mission_id`, `keyword`, `time`) VALUES
(5, 2, 'data mining', '2015-11-08 14:47:21'),
(4, 2, 'good', '2015-10-28 08:51:13');
...
INSERT INTO `preference_paper` (`id`, `mission_id`, `item_ut`, `rating`, `mission_round`, `time`) VALUES
